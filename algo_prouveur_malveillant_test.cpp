...
int main(int argc, char* argv[])
{
    ...
    //Génération du prouveur et du vérifieur
    Verifieur current_verifier(publicKey, cypher);
    ...
    current_verifier.genere_monomes(gamma, n);
    ...
    if (current_verifier.verification(v ,e_z, r_z ,r_bound_z ,e_bound_z ,w))
